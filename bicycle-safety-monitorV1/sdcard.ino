...
void saveData(){
    ...
    + String(gpsalt) + "," + String(gpsvel) + "," + String(accx) + "," + String(accy) + "," + String(accz) + "," + String(rotx) + "," + String(roty) + "," + String(rotz) + "," + String(dist1) + "," + String(dist2) + "," + String(acctemp) + "," + String(botaoStatus) + "," + "\r\n"; 
...
void checkSDFile(){
  ...
  if(!file) {
    ...
    delay(2000);
    writeFile(SD, "/data.csv", "Data, Hora, Lat, Long, Alt, Vel, AccX, AccY, AccZ, RotX, RotY, RotZ, Dist1, Dist2, Temp, Botao \r\n");
  }
  else {
